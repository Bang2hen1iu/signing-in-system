...
ALTER TABLE absence
  ADD PRIMARY KEY (id);
ALTER TABLE absence
  ADD FOREIGN KEY (sign_in_info_id) REFERENCES sign_in_info_v2 (id);

ALTER TABLE course_per_week
  ADD course_id BIGINT;
ALTER TABLE course_per_week
  DROP CONSTRAINT course_per_week_pkey;
ALTER TABLE course_per_week
  ADD PRIMARY KEY (course_id, weekday);
